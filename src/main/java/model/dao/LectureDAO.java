...
public class LectureDAO {
		...
		try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
			...
			try (ResultSet rs = pstmt.executeQuery()) {
				while (rs.next()) {
					...
					dto.setAppliedAt(appliedAt != null ? appliedAt.toLocalDateTime() : null);
	...
	public List<LectureDTO> findAll() {
		String sql = "SELECT lecture_id, user_id, lecture_title, lecture_round, "
				+ "       start_date, end_date, status, room, capacity, "
				+ "       created_at, updated_at, validation, section " + "FROM lecture "
				+ "WHERE validation = 'CONFIRMED' " + "ORDER BY lecture_title, lecture_round";
	...
	public List<LectureDTO> findByInstructor(Long instructorId) {
		String sql = "SELECT lecture_id, user_id, lecture_title, lecture_round, "
				+ "       start_date, end_date, status, room, capacity, "
				+ "       created_at, updated_at, validation, section " + "FROM lecture "
				+ "WHERE validation = 'CONFIRMED' AND user_id = ? " + "ORDER BY lecture_title, lecture_round";
	...
	public List<LectureDTO> findByStudent(Long studentId) {
		String sql = "SELECT l.lecture_id, l.user_id, l.lecture_title, l.lecture_round, "
				+ "       l.start_date, l.end_date, l.status, l.room, l.capacity, "
				+ "       l.created_at, l.updated_at, l.validation, l.section " + "FROM lecture l "
	...
	public LectureDTO findById(Long lectureId) {
		String sql = "SELECT lecture_id, user_id, lecture_title, lecture_round, "
				+ "       start_date, end_date, status, room, capacity, "
				+ "       created_at, updated_at, validation, section " + "FROM lecture " + "WHERE lecture_id = ?";
