...
public class LectureRequestDAO {
	...
	public Long insertLecture(Connection conn, Long instructorId, HttpServletRequest request) throws SQLException {
		...
		Long departmentId = findDepartmentIdByInstructor(conn, instructorId);
		...
		try (PreparedStatement pstmt = conn.prepareStatement(sql, PreparedStatement.RETURN_GENERATED_KEYS)) {
			...
			pstmt.setString(3, request.getParameter("lectureTitle"));
			pstmt.setInt(4, Integer.parseInt(request.getParameter("lectureRound")));
			...
			pstmt.setInt(8, Integer.parseInt(request.getParameter("capacity")));
			pstmt.setString(9, request.getParameter("section"));
	...
	private Long findDepartmentIdByInstructor(
	    ...
	    throw new SQLException("강사의 department_id를 찾을 수 없습니다.");
	}
