...
<form method="post"
    ...
    <div class="col-md-6">
        ...
        <input type="text" name="lectureTitle"
               class="form-control"
               value="${request.lectureTitle}" required>
    </div>
    ...
    <div class="col-md-3">
        ...
        <input type="number" name="lectureRound"
               class="form-control"
               value="${request.lectureRound}" required>
    </div>
    ...
    <div class="col-md-3">
        ...
        <input type="number" name="capacity"
               class="form-control"
               value="${request.capacity}" required>
    </div>
