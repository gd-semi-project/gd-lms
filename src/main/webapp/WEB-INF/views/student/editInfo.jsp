      ...
      <tbody>
        <tr>
          ...
          <td><input 
				...
				value="${mypage.student.studentNumber}"
				readonly="readonly">
			</td>
        </tr>
        <tr>
          ...
          <td><input 
				class="form-control read-only"
				value="${mypage.department.departmentName}"
				readonly="readonly">
			</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input 
				class="form-control read-only"
				value="${mypage.student.studentStatus}"
				readonly="readonly">
			</td>
        </tr>
        <tr>
          <th scope="row">입학일자</th>
           <td><input 
				class="form-control read-only"
				value="${mypage.student.enrollDate}"
				readonly="readonly">
			</td>
        </tr>
        <tr>
